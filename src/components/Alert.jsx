...
const Alert = ({type,text}) => {
  return (
    <div
    className="absolute top-16 left-0 right-0 flex justify-center items-center"
    >
        <div
        className={`${type==='danger'?'bg-red-800':'bg-blue-800'} p-2 text-indigo-100 leading-none rounded-full lg:rounded-full 
